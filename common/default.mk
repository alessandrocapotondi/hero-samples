...
reset-driver: remove-driver insert-driver
...
ifeq ($(call ifndef_any_of,HERO_TARGET_HOST HERO_TARGET_PATH_APPS HERO_TARGET_PATH_LIB),)
	ssh -t $(HERO_TARGET_HOST) 'export LD_LIBRARY_PATH='"'$(HERO_TARGET_PATH_LIB)'"'; cd ${HERO_TARGET_PATH_APPS}; LIBOMPTARGET_INFO=-1 LIBOMPTARGET_DEBUG=-1 LIBOMPTARGET_DEVICE_RTL_DEBUG=-1 ./$(EXE) $(RUN_ARGS)'
else
